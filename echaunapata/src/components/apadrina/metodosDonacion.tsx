import { CreditCard, Smartphone, DollarSign, Mail } from "lucide-react";
import Lottie from "lottie-react";
import moneyDog from "../../assets/animations/moneydog.json";
  ...
  return (
    <section className="w-full py-14 px-6">
      <div className="max-w-6xl mx-auto">
        {/* ANIMACIÓN PEQUEÑA */}
        <div className="w-30 mx-auto mb-4 opacity-90">
          <Lottie animationData={moneyDog} loop autoplay />
        </div>
