    ...
    <section className="w-full bg-white py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-[1500px] w-full mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          "
          >
            Échame una pata SV es un hogar temporal para miles de cachorros que
            buscan una segunda oportunidad, pero también somos el hogar
            permanente de muchos otros que podrían no encontrar una familia
